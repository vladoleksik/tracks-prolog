...
decode(95, _).
decode(226, C) :- get_code(_), get_code(X), decode_track(X,C).

decode_track(144, cert(horiz)).
decode_track(157, cert(nw)).
decode_track(353, cert(ne)).
decode_track(8212, cert(sw)).
decode_track(8216, cert(vert)).
decode_track(8221, cert(se)).
%--------------------------------------------------------------------------------
